...
public class ChestTrackNoBandActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFinishedButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mLoggedIn == false) {
                    Toast.makeText(ChestTrackNoBandActivity.this, "Log In", Toast.LENGTH_SHORT).show();
                } else {
                    db.insert(DbSchema.ChestTable.NAME, null, values);
                    Toast.makeText(ChestTrackNoBandActivity.this, "Added", Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
        });
