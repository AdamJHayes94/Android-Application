...
public class BicepCurlTrackActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mYesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mLoggedIn = ((MyApplication) BicepCurlTrackActivity.this.getApplication()).getLoggedIn();
                if (mLoggedIn == false) {
                    Toast.makeText(BicepCurlTrackActivity.this, "Log In", Toast.LENGTH_SHORT).show();
                } else {
                    db.insert(DbSchema.BicepTable.NAME, null, values);
                    Toast.makeText(BicepCurlTrackActivity.this, "Added", Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
        });
        ...
        mNoButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(BicepCurlTrackActivity.this, "Try Again", Toast.LENGTH_SHORT).show();
                recreate();
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (bandClient != null) {
                    try {
                        ...
                        Toast.makeText(BicepCurlTrackActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show(); //exception toast
                    }
                }
                mStopButton.setVisibility(View.GONE);
        ...
        protected Void doInBackground(Void... params) {
            try {
                if (isBandConnected()) {
                    ...
                    Toast.makeText(BicepCurlTrackActivity.this, "Band not connected", Toast.LENGTH_SHORT).show();
                }
                ...
                switch (e.getErrorType()){
                    ...
                    default:
                        ...
                        break;
                } Toast.makeText(BicepCurlTrackActivity.this, exceptionMessage, Toast.LENGTH_SHORT).show();
            } catch (Exception e) {
                Toast.makeText(BicepCurlTrackActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
            return null;
        }
